...
type SqlBaseListener interface {
	...
	// EnterPauseQuery is called when entering the pauseQuery production.
	EnterPauseQuery(c *PauseQueryContext)

	// EnterResumeQuery is called when entering the resumeQuery production.
	EnterResumeQuery(c *ResumeQueryContext)

	// EnterSetProperty is called when entering the setProperty production.
	EnterSetProperty(c *SetPropertyContext)

	// EnterAlterSystemProperty is called when entering the alterSystemProperty production.
	EnterAlterSystemProperty(c *AlterSystemPropertyContext)
	...
	// EnterAssertTopic is called when entering the assertTopic production.
	EnterAssertTopic(c *AssertTopicContext)

	// EnterAssertSchema is called when entering the assertSchema production.
	EnterAssertSchema(c *AssertSchemaContext)
	...
	// EnterResourceName is called when entering the resourceName production.
	EnterResourceName(c *ResourceNameContext)
	...
	// EnterSelectStructAll is called when entering the selectStructAll production.
	EnterSelectStructAll(c *SelectStructAllContext)
	...
	// EnterRightJoin is called when entering the rightJoin production.
	EnterRightJoin(c *RightJoinContext)
	...
	// ExitPauseQuery is called when exiting the pauseQuery production.
	ExitPauseQuery(c *PauseQueryContext)

	// ExitResumeQuery is called when exiting the resumeQuery production.
	ExitResumeQuery(c *ResumeQueryContext)

	// ExitSetProperty is called when exiting the setProperty production.
	ExitSetProperty(c *SetPropertyContext)

	// ExitAlterSystemProperty is called when exiting the alterSystemProperty production.
	ExitAlterSystemProperty(c *AlterSystemPropertyContext)
	...
	// ExitAssertTopic is called when exiting the assertTopic production.
	ExitAssertTopic(c *AssertTopicContext)

	// ExitAssertSchema is called when exiting the assertSchema production.
	ExitAssertSchema(c *AssertSchemaContext)
	...
	// ExitResourceName is called when exiting the resourceName production.
	ExitResourceName(c *ResourceNameContext)
	...
	// ExitSelectStructAll is called when exiting the selectStructAll production.
	ExitSelectStructAll(c *SelectStructAllContext)
	...
	// ExitRightJoin is called when exiting the rightJoin production.
	ExitRightJoin(c *RightJoinContext)
